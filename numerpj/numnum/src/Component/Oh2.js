    ...
    render() {
        return (
            <div className='bg'>
                ...
                <h1 class="butto">Oh^2</h1>
                <Input class="input"  name="N" onChange={this.input.bind(this)} placeholder="n" />
                <Input class="input"  name="H" onChange={this.input.bind(this)} placeholder="h" />
                    
                </div>
                <Button style={{margin:"30px"}} class="butto" type="primary" size="large" onClick={this.compute.bind(this)}>Submit</Button>
